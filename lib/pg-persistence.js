...
module.exports = class PgPersistence {
  ...
  async authenticate(username, password) { // I want to shorten this but I'm not supposed to change the API, right?
  ...
  async completeAllTodos(todoListId) {
    let COMPLETE_ALL = "UPDATE todos SET done = TRUE WHERE todolist_id = $1 AND NOT done AND username = $2";
